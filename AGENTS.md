...
| `CLAUDE.md`, `.cursor/rules/`, `.github/copilot-instructions.md` | Thin per-tool pointers to this file (ADR 0007). |
...
| `tests/` | [bats](https://bats-core.readthedocs.io/) unit tests, one suite per script in `scripts/`. |
